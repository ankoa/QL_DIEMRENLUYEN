...
namespace CustomControls.RJControls
{
    ...
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = ByteArrayToImage(ql_diemrenluyen.Properties.Resources.calendarWhite);
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = ByteArrayToImage(ql_diemrenluyen.Properties.Resources.calendarDark);
                else calendarIcon = ByteArrayToImage(ql_diemrenluyen.Properties.Resources.calendarWhite);
                this.Invalidate();
            }
        }
